(function () {
	...
	*/
	...
	const serverBinder = RuleBinder.createServerBound();
	const clientBinder = RuleBinder.createClientBound();
	...
	function storageRoamingSave(disableLocalService = false)
	{
	    let storageJson = "";
	    try
	    {
	 ...
	 */
	async function showSearchRecordViewer(keyword)
	{
	    let allRecord = getLocalRecordList();
